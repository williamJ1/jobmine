...
#reviews
review1 = Review.create(rating: 4, title:'Good', body: 'Good proformance! This sort of feedback tells Jill that she needs to work on prioritizing and meeting goals, but it also offers a solution—a daily check-in to help her establish priorities.

Assume that most employees want to do the right thing. Unless Jill’s wasting time posting selfies on Instagram, it’s likely she’s well aware of her problem with meeting deadlines and wants to get better. Rather than pointing out the obvious (Jill struggles to prioritize), it’s important to offer a solution that will work for both of you.', profile_id: teen_profile.id, reviewer: 'Roberto_Murphy@e.com',reviewer_id: emp_profile_1.id, contract_id: contract7.id)
...
review3 = Review.create(rating: 3.5, title:'Good', body: 'Good proformance! This sort of feedback tells Jill that she needs to work on prioritizing and meeting goals, but it also offers a solution—a daily check-in to help her establish priorities.

Assume that most employees want to do the right thing. Unless Jill’s wasting time posting selfies on Instagram, it’s likely she’s well aware of her problem with meeting deadlines and wants to get better. Rather than pointing out the obvious (Jill struggles to prioritize), it’s important to offer a solution that will work for both of you.', profile_id: teen_profile.id, reviewer: 'Roberto_Murphy@e.com',reviewer_id: emp_profile_1.id, contract_id: contract8.id)
review4 = Review.create(rating: 1, title:'Bad', body: 'Bad work -_-. This comment is both hyperbole (Jill isn’t always distracted; otherwise, she’d never get a single thing done!) and a generalization. Starting any piece of feedback with “You always do X” is bound to raise a person’s defenses and create negative feelings. It’s also not actionable. If distractibility is hardwired into Jill’s nature, how will telling her what she already knows help her improve?', profile_id: teen_profile.id, reviewer: 'Roberto_Murphy@e.com',reviewer_id: emp_profile_1.id, contract_id: contract7.id)
review5 = Review.create(rating: 5, title:'Excellent', body: 'Excellent work!! Samuel exceeds expectations in the role of a sales associate. He adapts to change easily, works well under pressure with a positive attitude and is detail-oriented. Samuel goes beyond the call of duty by seeking out and following up on additional responsibilities, and contributes frequently to department meetings.', profile_id: teen_profile.id, reviewer: 'Roberto_Murphy@e.com',reviewer_id: emp_profile_1.id, contract_id: contract8.id)
review6 = Review.create(rating: 3.5, title:'Good', body: 'Good proformance! This sort of feedback tells Jill that she needs to work on prioritizing and meeting goals, but it also offers a solution—a daily check-in to help her establish priorities.

Assume that most employees want to do the right thing. Unless Jill’s wasting time posting selfies on Instagram, it’s likely she’s well aware of her problem with meeting deadlines and wants to get better. Rather than pointing out the obvious (Jill struggles to prioritize), it’s important to offer a solution that will work for both of you.', profile_id: emp_profile_1.id, reviewer: 'Stephen_Smith@t.com',reviewer_id: teen_profile.id, contract_id: contract7.id)
review7 = Review.create(rating: 4, title:'Good', body: 'Good proformance! This sort of feedback tells Jill that she needs to work on prioritizing and meeting goals, but it also offers a solution—a daily check-in to help her establish priorities.

Assume that most employees want to do the right thing. Unless Jill’s wasting time posting selfies on Instagram, it’s likely she’s well aware of her problem with meeting deadlines and wants to get better. Rather than pointing out the obvious (Jill struggles to prioritize), it’s important to offer a solution that will work for both of you.', profile_id: emp_profile_1.id, reviewer: 'Stephen_Smith@t.com',reviewer_id: teen_profile.id, contract_id: contract8.id)
review8 = Review.create(rating: 3.5, title:'Good', body: 'Good proformance! This sort of feedback tells Jill that she needs to work on prioritizing and meeting goals, but it also offers a solution—a daily check-in to help her establish priorities.

Assume that most employees want to do the right thing. Unless Jill’s wasting time posting selfies on Instagram, it’s likely she’s well aware of her problem with meeting deadlines and wants to get better. Rather than pointing out the obvious (Jill struggles to prioritize), it’s important to offer a solution that will work for both of you.', profile_id: emp_profile_1.id, reviewer: 'Stephen_Smith@t.com',reviewer_id: teen_profile.id, contract_id: contract8.id)
review9 = Review.create(rating: 1.5, title:'Bad', body: 'Bad work -_-. This comment is both hyperbole (Jill isn’t always distracted; otherwise, she’d never get a single thing done!) and a generalization. Starting any piece of feedback with “You always do X” is bound to raise a person’s defenses and create negative feelings. It’s also not actionable. If distractibility is hardwired into Jill’s nature, how will telling her what she already knows help her improve?', profile_id: emp_profile_1.id, reviewer: 'Stephen_Smith@t.com',reviewer_id: teen_profile.id, contract_id: contract8.id)
review10 = Review.create(rating: 4.5, title:'Excellent', body: 'Excellent work!! Samuel exceeds expectations in the role of a sales associate. He adapts to change easily, works well under pressure with a positive attitude and is detail-oriented. Samuel goes beyond the call of duty by seeking out and following up on additional responsibilities, and contributes frequently to department meetings.', profile_id: emp_profile_1.id, reviewer: 'Stephen_Smith@t.com',reviewer_id: teen_profile.id, contract_id: contract7.id)

reviewa = Review.create(rating: 4, title:'Good', body: 'Good proformance! This sort of feedback tells Jill that she needs to work on prioritizing and meeting goals, but it also offers a solution—a daily check-in to help her establish priorities.

Assume that most employees want to do the right thing. Unless Jill’s wasting time posting selfies on Instagram, it’s likely she’s well aware of her problem with meeting deadlines and wants to get better. Rather than pointing out the obvious (Jill struggles to prioritize), it’s important to offer a solution that will work for both of you.', profile_id: teen_profile.id, reviewer: 'Roberto_Murphy@e.com',reviewer_id: emp_profile_1.id, contract_id: contract7.id)
reviewb = Review.create(rating: 4, title:'Good', body: 'Good proformance! This sort of feedback tells Jill that she needs to work on prioritizing and meeting goals, but it also offers a solution—a daily check-in to help her establish priorities.

Assume that most employees want to do the right thing. Unless Jill’s wasting time posting selfies on Instagram, it’s likely she’s well aware of her problem with meeting deadlines and wants to get better. Rather than pointing out the obvious (Jill struggles to prioritize), it’s important to offer a solution that will work for both of you.', profile_id: teen_profile.id, reviewer: 'Roberto_Murphy@e.com',reviewer_id: emp_profile_1.id, contract_id: contract7.id)
reviewc = Review.create(rating: 4, title:'Good', body: 'Good proformance! This sort of feedback tells Jill that she needs to work on prioritizing and meeting goals, but it also offers a solution—a daily check-in to help her establish priorities.

Assume that most employees want to do the right thing. Unless Jill’s wasting time posting selfies on Instagram, it’s likely she’s well aware of her problem with meeting deadlines and wants to get better. Rather than pointing out the obvious (Jill struggles to prioritize), it’s important to offer a solution that will work for both of you.', profile_id: teen_profile.id, reviewer: 'Roberto_Murphy@e.com',reviewer_id: emp_profile_1.id, contract_id: contract7.id)
reviewd = Review.create(rating: 4, title:'Good', body: 'Good proformance! This sort of feedback tells Jill that she needs to work on prioritizing and meeting goals, but it also offers a solution—a daily check-in to help her establish priorities.

Assume that most employees want to do the right thing. Unless Jill’s wasting time posting selfies on Instagram, it’s likely she’s well aware of her problem with meeting deadlines and wants to get better. Rather than pointing out the obvious (Jill struggles to prioritize), it’s important to offer a solution that will work for both of you.', profile_id: teen_profile.id, reviewer: 'Roberto_Murphy@e.com',reviewer_id: emp_profile_1.id, contract_id: contract7.id)
reviewe = Review.create(rating: 4, title:'Good', body: 'Good proformance! This sort of feedback tells Jill that she needs to work on prioritizing and meeting goals, but it also offers a solution—a daily check-in to help her establish priorities.

Assume that most employees want to do the right thing. Unless Jill’s wasting time posting selfies on Instagram, it’s likely she’s well aware of her problem with meeting deadlines and wants to get better. Rather than pointing out the obvious (Jill struggles to prioritize), it’s important to offer a solution that will work for both of you.', profile_id: teen_profile.id, reviewer: 'Roberto_Murphy@e.com',reviewer_id: emp_profile_1.id, contract_id: contract7.id)
reviewf = Review.create(rating: 4, title:'Good', body: 'Good proformance! This sort of feedback tells Jill that she needs to work on prioritizing and meeting goals, but it also offers a solution—a daily check-in to help her establish priorities.
